...
from .views import (
    ...
    StudentProfileView,
    StudentClassesView,
    StudentActiveSessionView,
    StudentSubmitOTPView,
...
urlpatterns = [
    ...
    path('student/active-session/', StudentActiveSessionView.as_view(), name='student-active-session'),
    path('student/submit-otp/', StudentSubmitOTPView.as_view(), name='student-submit-otp'),
